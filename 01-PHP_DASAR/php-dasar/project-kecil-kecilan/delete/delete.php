    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item ms-4">
            <a class="nav-link active mt-2" href="delete.php"><img src="../assets/delete.png" alt="" class="mb-2" width="22px">Delete</a>
          </li>
          <li class="nav-item ms-4">
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr class="table-light">
          ...
          <td>
            <a href="hapus.php?id=<?= $students["id"]; ?>" class="btn btn-danger" tabindex="-1" role="button" aria-disabled="true">Delete</a>
          </td>
        </tr>
        <?php $i++; ?>
        <?php endforeach; ?>
