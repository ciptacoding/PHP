...
<body id="page-top">
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <div class="row justify-content-between mb-3">
                <div class="col-auto">
                  <form action="" method="post">
                    <div class="input-group">
                      <input type="text" class="form-control form-control" id="keywordMahasiswa" name="keywordMahasiswa" value="<?= $keyword ?>" placeholder="Search...">
                ...
                <div class="col-auto">
                  <a href="<?= url_root() ?>export.php" target="_blank" class="btn btn-success">Export</a>
                </div>
              </div>
                    ...
                    <?php foreach ($mahasiswa as $ma) : ?>
                      <tr>
                        ...
                        <td class="align-middle text-nowrap">
                          <a href="<?= url_root() ?>/admin/mahasiswa-edit.php?id=<?= $ma['id'] ?>" class="btn btn-primary btn-sm py-0">Edit</a>
                          <form action="<?= url_root() ?>/admin/mahasiswa-delete.php" method="post" onsubmit="return confirm('yakin?')" class="d-inline-block">
                            ...
                            <button type="submit" class="btn btn-secondary btn-sm py-0">Delete</button>
                          </form>
                        </td>
                      </tr>
                    <?php endforeach ?>
  ...
  <!-- Logout Modal-->
  <?php include APP_ROOT . '/includes/logout-modal.php'; ?>
